    ...
    <div>
      ...
      <div className="bg-image">
        <div className="products-important text-start ">
          <h1 className="products--products ">{content[lang]?.categories}</h1>
          <p>
      ...
      <section className="container" >
        ...
        <div class="row  mt-5 ">
          {count > 0 ? (
            categories?.map((item) => {
              return (
                <div className="col-12 col-sm-12  col-md-6  col-lg-4  col-xl-3 px-3 ">
                  <div
                    class="  div_shadow  mt-4 w-100"
                    style={{ padding: "22px 40px", paddingBottom: "30px" }}
                  >
                    <Link to={`/categories/${item.guid}`}>
                      <img
